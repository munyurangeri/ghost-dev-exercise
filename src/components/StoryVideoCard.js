  ...
  const markups = `
    <div class="flex flex-col justify-center items-center gap-5 w-full h-screen xl:mt-[2.3555rem] xl:w-auto xl:h-auto">            
      <div class="w-10/12 flex justify-between gap-4 xl:hidden">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8 text-[#262861]">
          <path d="M11.25 4.533A9.707 9.707 0 0 0 6 3a9.735 9.735 0 0 0-3.25.555.75.75 0 0 0-.5.707v14.25a.75.75 0 0 0 1 .707A8.237 8.237 0 0 1 6 18.75c1.995 0 3.823.707 5.25 1.886V4.533ZM12.75 20.636A8.214 8.214 0 0 1 18 18.75c.966 0 1.89.166 2.75.47a.75.75 0 0 0 1-.708V4.262a.75.75 0 0 0-.5-.707A9.735 9.735 0 0 0 18 3a9.707 9.707 0 0 0-5.25 1.533v16.103Z" />
        </svg>
      </div>
      <div class="hidden xl:flex flex-col justify-center items-center w-10/12 xl:w-[52.688rem] h-3/6 xl:h-[29.586rem] bg-center bg-cover bg-no-repeat bg-[url('../data/images/pic-1.jpg')] rounded">
        ${PlayButton({})}
      </div>
      <div class="w-10/12  h-3/6 rounded xl:hidden">
        ${StoryCard({})}
      </div>
      <!-- TODO: Make scroll button component to replace these dots -->
      <div class="hidden xl:flex justify-start gap-2 w-10/12 xl:w-full">
        ${ImageSwitcher({
          id: "one",
          tag: "button",
          selector: "one",
